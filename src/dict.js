...
export const ADAS_ACTIVE_FLAG = { 0x01: '开始', 0x02: '结束' };
export const ADAS_ACTIVE_LEVEL = { 0x01: '一级报警(1张图片)', 0x02: '二级报警(1张图片+10秒视频)' };
export const ADAS_ACTIVE_DEVIATION = { 0x01: '左侧偏离', 0x02: '右侧偏离' };
export const ADAS_ACTIVE_ROADSIGN = { 0x01: '限速标志', 0x02: '限高标志', 0x03: '限重标志' };
