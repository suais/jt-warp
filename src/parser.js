...
import {
  MSG_808, MSG_809, PROVINCES, ALARM_FLAGS, STATUS_FLAGS, LOCATION_EXTRAS,
...
let GBK_TABLE = null;
export function _setGbkTable(t) { GBK_TABLE = t || null; }
...
export function findHeadPlate(headBytes) {
 ...
 * ===================================================================== */
export function scanEmbedded(input) {
 ...
 * ===================================================================== */
export function parseRawBody(msgId, input, opts = {}) {
 ...
 * 反向：构造报文（编码）—— 便于测试与造数据
 * ===================================================================== */
export function buildFrame(msgId, headerOpts, bodyBytes) {
...
export { parseHeader, parseBody, bytesToHex as toHex, f as mkField };
